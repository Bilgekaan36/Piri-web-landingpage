...
const TagCloud = () => {
  ...
  return (
    <div className={styles.container}>
      ...
      <ul ref={tagRef} className='tags-cloud'>
        <li className='tag'>
          <span className='wrap'>HTML</span>
        </li>
        <li className='tag'>
          <span className='wrap'>React</span>
        </li>
        <li className='tag'>
          <span className='wrap'>CSS</span>
        </li>
        <li className='tag'>
          <span className='wrap'>Vue</span>
        </li>
        <li className='tag'>
          <span className='wrap'>MongoDB</span>
        </li>
        <li className='tag'>
          <span className='wrap'>SCSS</span>
        </li>
        <li className='tag'>
        ...
        <li className='tag'>
          <span className='wrap'>Next.js</span>
        </li>
        <li className='tag'>
          <span className='wrap'>Webpack</span>
        </li>
        <li className='tag'>
          <span className='wrap'>Firebase</span>
        </li>
        <li className='tag'>
          <span className='wrap'>Vercel</span>
        </li>
        <li className='tag'>
          <span className='wrap'>Three.js</span>
        </li>
        <li className='tag'>
          <span className='wrap'>Express.js</span>
        </li>
        <li className='tag'>
          <span className='wrap'>Node.js</span>
        </li>
        <li className='tag'>
          <span className='wrap'>Git</span>
        </li>
        <li className='tag'>
          <span className='wrap'>MacOs</span>
        </li>
        <li className='tag'>
          <span className='wrap'>Windows</span>
        </li>
        <li className='tag'>
          <span className='wrap'>SQL</span>
        </li>
      </ul>
    </div>
  );
